...
public:
    ...
    virtual void addFile(const std::string &name, const std::string &sha256) = 0;
...
protected:
    ...
    bool tryLoadFromCache(const std::string &name, const std::string &sha256,
            Client *client);

    bool checkAndLoad(const std::string &name, const std::string &sha256,
...
public:
    ...
    void addFile(const std::string &name, const std::string &sha256) override;
